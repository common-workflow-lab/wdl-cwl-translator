...
cwltest: wdl2cwl/tests/cwl_files/*.cwl wdl2cwl/tests/*
	cd wdl2cwl/tests && cwltest --timeout 1200 --verbose --junit-verbose --tool cwltool --test cwl_tests.yaml -- --cachedir cache --debug --strict-memory-limit

cwltest_big: wdl2cwl/tests/cwl_files/*.cwl wdl2cwl/tests/*
	cd wdl2cwl/tests && cwltest --timeout 1200 --verbose --junit-verbose --tool cwltool --test cwl_tests_big.yaml -- --cachedir cache --debug --strict-memory-limit
