  ...
  - cwlVersion: v1.2
    ...
    outputs:
      - id: sequence_grouping
        type:
          name: _sequence_grouping_string_array_array
          items:
            name: _sequence_grouping_string_array
            items: string
            type: array
          type: array
        outputBinding:
      ...
      - id: sequence_grouping_with_unmapped
        type:
          name: _sequence_grouping_with_unmapped_string_array_array
          items:
            name: _sequence_grouping_with_unmapped_string_array
            items: string
            type: array
          type: array
        outputBinding:
    ...
    hints:
      ...
      - class: ResourceRequirement
        ...
        outdirMin: $((Math.ceil(2 * 
          (function(size_of=0){inputs.input_bam.forEach(function(element){ if 
