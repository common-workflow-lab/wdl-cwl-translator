...
steps:
  ...
  - id: _BuildStarSingleNucleus.modified_references.genome_fa
    ...
    out:
      - genome_fa
    run:
      id: _BuildStarSingleNucleus.modified_references.genome_fa_etool
      class: ExpressionTool
      inputs:
        - id: target
          type: Any
  ...
  - id: _BuildStarSingleNucleus.modified_references.annotation_gtf
    ...
    out:
      - annotation_gtf
    run:
      id: _BuildStarSingleNucleus.modified_references.annotation_gtf_etool
      class: ExpressionTool
      inputs:
        - id: target
          type: Any
    ...
    run:
      ...
      outputs:
        - id: star_index
          type: File
          outputBinding:
            glob: $("star_primary_gencode_" + inputs.organism + "_v" + 
              inputs.gtf_version + ".tar")
      requirements:
        - class: InitialWorkDirRequirement
          listing:
            - entryname: script.bash
    ...
    run:
      ...
      outputs:
        ...
        - id: annotation_gtf_modified_introns
          type: File
          outputBinding:
            glob: $("introns_modified_gencode.v" + inputs.gtf_version + 
              ".primary_assembly.annotation.gtf")
        - id: modified_references
          type:
            name: References
          ...
          outputBinding:
            outputEval: '$({ "genome_fa": { "class": "File", "path": runtime.outdir+"/"+"modified_GRC"
              + inputs.organism_prefix + "38.primary_assembly.genome.fa" }, "annotation_gtf":
              { "class": "File", "path": runtime.outdir+"/"+"modified_gencode.v" +
    ...
    run:
      ...
      outputs:
        - id: rsem_index
          type: File
          outputBinding:
            glob: $("rsem_primary_gencode_" + inputs.organism + "_v" + 
              inputs.gtf_version + ".tar")
      requirements:
        - class: InitialWorkDirRequirement
          listing:
      ...
      hints:
        - class: DockerRequirement
          dockerPull: 
            quay.io/humancellatlas/secondary-analysis-rsem:v0.2.2-1.3.0
        - class: ResourceRequirement
          ramMin: 10240.0
          outdirMin: 102400
      cwlVersion: v1.2
    ...
    run:
      ...
      outputs:
        - id: hisat2_index
          type: File
          outputBinding:
            glob: $("hisat2_from_rsem_" + 
              inputs.rsem_index.basename.replace(/\.tar$/, '')  + ".tar.gz")
      requirements:
        - class: InitialWorkDirRequirement
          listing:
            - entryname: script.bash
      ...
      hints:
        - class: DockerRequirement
          dockerPull: 
            quay.io/humancellatlas/secondary-analysis-hisat2:v0.2.2-2-2.1.0
        - class: ResourceRequirement
          coresMin: 8
          ramMin: 8192.0
          outdirMin: 102400
    ...
    run:
      ...
      outputs:
        - id: hisat2_index
          type: File
          outputBinding:
            glob: $("hisat2_primary_gencode_" + inputs.organism + "_v" + 
              inputs.gtf_version + ".tar.gz")
      requirements:
        - class: InitialWorkDirRequirement
          listing:
            - entryname: script.bash
  ...
  - id: BuildHisat2SnpHaplotypeSplicing
    ...
    run:
      ...
      hints:
        - class: DockerRequirement
          dockerPull: 
            quay.io/humancellatlas/secondary-analysis-hisat2:v0.3.0-2-2.1.0
        - class: ResourceRequirement
          coresMin: 16
          ramMin: 245760.0
          outdirMin: 102400
...
outputs:
  ...
  - id: BuildIndices.snSS2_genome_fa
    outputSource: 
      _BuildStarSingleNucleus.modified_references.genome_fa/genome_fa
    type: File
  - id: BuildIndices.snSS2_annotation_gtf
    outputSource: 
      _BuildStarSingleNucleus.modified_references.annotation_gtf/annotation_gtf
    type: File
