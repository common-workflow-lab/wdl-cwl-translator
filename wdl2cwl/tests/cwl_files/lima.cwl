...
inputs:
  ...
  - id: minScoringRegion
    ...
    type: int
  - id: minScore
    doc: Reads below the minimum barcode score are removed from downstream 
      analysis.
    default: 0
    type: int
  - id: minEndScore
  ...
  - id: guessMinCount
    ...
    type: int
  - id: peekGuess
    doc: Try to infer the used barcodes subset, by peeking at the first 50,000 
      ZMWs.
    default: false
    type: boolean
  - id: logLevel
