...
$graph:
  - cwlVersion: v1.2
    ...
    inputs:
      ...
      - id: nameTable
        ...
        type: File
      - id: referenceFile
        doc: A comma-separated list of fasta files containing the reference 
          sequences to be aligned to.
        type: File
      - id: indexBasename
      ...
      - id: ftabChars
        ...
        type:
          ...
          - 'null'
      - id: kmerCount
        doc: Use <int> as kmer-size for counting the distinct number of k-mers 
          in the input sequences.
        type:
          - int
          - 'null'
      - id: sizeTable
        doc: List of taxonomic IDs and lengths of the sequences belonging to the
          same taxonomic IDs.
        type:
          - File
          - 'null'
  ...
  - cwlVersion: v1.2
    ...
    inputs:
      ...
      - id: reportMaxDistinct
        doc: It searches for at most <int> distinct, primary assignments for 
          each read or pair.
        type:
          - int
          - 'null'
      - id: hostTaxIDs
        doc: A comma-separated list of taxonomic IDs that will be preferred in 
          classification procedure.
        type:
          - string
          - 'null'
      - id: excludeTaxIDs
        doc: A comma-separated list of taxonomic IDs that will be excluded in 
          classification procedure.
        type:
          - string
          - 'null'
    ...
    baseCommand:
      ...
      - script.bash
    arguments:
      - valueFrom: ${if (inputs.read1.length == 0) {throw "read1 must contain at
          least one item.";} else { return "";}}
      - valueFrom: ${if (inputs.indexFiles.length == 0) {throw "indexFiles must 
  ...
  - cwlVersion: v1.2
    ...
    inputs:
      - id: printOption
        doc: The output option for inspect (fasta, summary, conversionTable, 
          taxonomyTree, nameTable, sizeTable)
        default: fasta
        type: string
      - id: indexFiles
        doc: The files of the index for the reference genomes.
      ...
      - id: outputPrefix
        ...
        type: string
      - id: across
        doc: When printing fasta output, output a newline character every <int> 
          bases.
        type:
          - int
          - 'null'
