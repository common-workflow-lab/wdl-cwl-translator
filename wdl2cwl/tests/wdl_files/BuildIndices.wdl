...
# source https://github.com/broadinstitute/warp/blob/bc90b0db0138747685b459c83ce52c8576ce03cd/pipelines/skylab/build_indices/BuildIndices.wdl
...
task BuildIntervalList {
  ...
  command <<<
    ...
    mkdir genome_fa
    ln -s ~{references.genome_fa} genome_fa/~{basename(references.genome_fa)}
    samtools faidx genome_fa/~{basename(references.genome_fa)}
    cut -f1,2 genome_fa/~{basename(references.genome_fa)}.fai > sizes.genome
