...
task Mem {
    input {
        ...
        Int threads = 4
        Int? memoryGb
        Int timeMinutes = 10 + ceil(size([read1, read2], "K") * 300 / threads)
    ...
    Int estimatedMemoryGb = 10 + ceil(size(bwaIndex.indexFiles, "M") * 2) + sortMemoryPerThreadGb * totalSortThreads
    ...
    runtime {
        ...
        cpu: threads
        memory: "~{select_first([memoryGb, estimatedMemoryGb])}T"
